...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			<h1 class="entry-title entry-prop">Đăng tin Tìm người</h1>
			<hr>
          ...
          @if(Auth::user()->tinhtrang != 0)
            ...
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
						...
						<div class="form-group">
							<label>Địa chỉ công việc:</label> Bạn có thể nhập hoặc chọn ví trí trên bản đồ 
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="usr">Mức lương( vnđ ):</label>
                  <input type="number" name="txtprice" class="form-control" placeholder="750000" >
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="usr">Số lượng cần tuyển:</label>
                  <input type="number" name="txtarea" class="form-control" placeholder="VD:1">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="txtphone" class="form-control" placeholder="VD: 0967594691">
                </div>
              </div>
            </div> 
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="usr">Kinh nghiệm:</label>
                  <input type="number" name="txtexp" class="form-control" placeholder="VD:2 năm">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="usr">Hình thức làm việc:</label>
                  <select id="selectpicker pull-right" name="tienich[]" class="form-control" placeholder="Chọn hình thức làm việc">
            ...
            <div class="form-group">
              <!-- ************** Max Items Demo ************** -->
              <label>Kỹ Năng:</label>
              <select id="select-state" name="kynang[]" multiple class="demo-default" placeholder="Chọn kỹ năng">
                ...
                <option value="HTrình diễn điện tử" >Trình diễn điện tử </option>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" rows="5" name="txtrequests" style=" resize: none;"></textarea>
            </div>
            <div class="form-group">
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyANyFJxSMfXQgwzYkqjOJUM5ZpiFzvecag&callback=initialize&libraries=geometry,places" async defer></script>
<script>
  var map;
  var marker;
  function initialize() {
