			...
			<div class="col-12">
				<div class="panel panel-flat">
					<div class="panel-body">
						Chào mừng bạn đến với Trang quản trị TimViecBT
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-4">
				...
				<div class="panel bg-pink-400">
					<div class="panel-body">
						...
						Công việc đã duyệt
						<div class="text-muted text-size-small">trên tổng số {{ $total_rooms_approve + $total_rooms_unapprove }} công việc đã đăng</div>
					</div>
